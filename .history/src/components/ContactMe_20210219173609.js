            ...
            <div className="card-reveal">
              ...
              <div className="row">
                ...
                <div className="col s12 m12 l12">
                  <FontAwesomeIcon
                    className="grey-text contact-info col s12 m4 l3"
                    icon={faMobile}
                  />
                  {"  "}
                  <span className="col s12 m4 l3">+989129678332</span>
                  <FontAwesomeIcon
                    className="grey-text contact-info col s12 m4 l3"
                    icon={faEnvelope}
                  />
                  {"  "}
                  <span className="col s12 m4 l3">mjyousefi976@yahoo.com</span>
                  <FontAwesomeIcon
                    className="grey-text contact-info col s12 m4 l3"
                    icon={faPaperPlane}
                  />
                  {"  "}
                  <span className="col s12 m4 l3">@Mjavady976</span>
                </div>
              </div>
